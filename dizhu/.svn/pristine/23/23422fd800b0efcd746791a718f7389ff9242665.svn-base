...
from dizhu.games.arenamatch.policies import ArenaMatchFirstCallPolicyFinal
...
from dizhucomm.playmodes.base import SM_NORMAL, CallPolicyClassic3Player, SendCardsPolicy3PlayerDefault, CallPolicyHappy3Player, SettlementPolicyMatch, \
    CallPolicyLaizi
...
class DDZDealerNormalClassic(DealerBase):
    ...
    def __init__(self):
        super(DDZDealerNormalClassic, self).__init__(
            ...
            firstCallPolicy=ArenaMatchFirstCallPolicyFinal(),
