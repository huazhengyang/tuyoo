...
class MovesGener(object):
    ...
    def _gen_serial_moves(self, cards, min_serial, repeat=1, repeat_num=0):
        ...
        ret_moves = []
        for move in moves:
            if (12 in move) or (13 in move) or (14 in move):
                continue
    ...
    def gen_type_5_king_bomb(self):
        ...
        if 13 in self.cards_list and 14 in self.cards_list:
            self.final_bomb_moves.append([13, 14])
        return self.final_bomb_moves
