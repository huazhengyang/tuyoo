...
dizhu.playmodes.erdayimatch.aiplayer
@author: luwei
'''

from dizhucomm.core.cardrule import CardTypeDanPai, CardTypeDuizi, \
    CardTypeSanzhang, CardTypeZhadan, ReducedCards, CardTypeHuojian, \
    CardTypeFeijiDai1, CardTypeFeijiDai2, CardTypeSanShun, CardTypeShuangShun, \
...
class AIPlayer(object):
    ...
    def _doActiveOutCard(self, reducedCards):
        ...
        cards = self.findFirstCards(reducedCards, [CardTypeFeijiDai1, CardTypeFeijiDai2, CardTypeSanShun, CardTypeShuangShun, CardTypeDanShun, CardTypeSanDai1, CardTypeSanDai2])
        if cards:
            if ftlog.is_debug():
                ftlog.debug('<<< AIPlayer._doActiveOutCard handCards=', self.toHumanCards(reducedCards.cards),
                            'seatIndex=', self.player.seat.seatIndex,
