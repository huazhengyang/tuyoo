...
from dizhu.games.segmentmatch_ai.ctrlroom import DizhuCtrlRoomSegmentMatchAI
from dizhu.games.segmentmatch_ai.tableroom import DizhuTableRoomSegmentMatchAI
...
class TGDizhu(TYGame):
    ...
    def initGameBefore(self):
        ...
        tyRoomConst.ROOM_CLASS_DICT['dizhu_segment_match_ai'] = (DizhuCtrlRoomSegmentMatchAI, DizhuTableRoomSegmentMatchAI)
        ...
        from dizhu.entity.reward_system import reward_control_type
        reward_control_type._registerClasses()
