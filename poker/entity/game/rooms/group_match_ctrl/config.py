...
from poker.entity.game.rooms.group_match_ctrl.const import MatchType, FeesType, GroupingType, StageType, AnimationType, SeatQueuingType, MAX_CARD_COUNT, ScoreCalcType
...
class MatchConfig(object, ):
    VALID_GAMEIDS = [3, 6, 7, 15, 17, 20, 21]
