...
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_match_fees import AsyncCommonArenaFees
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_game_rewards import AsyncCommonArenaRewards
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_game_stages import AsyncCommonArenaStages
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_match_tips import AsyncCommonArenaTips
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_game_player import AsyncCommonArenaPlayer
from poker.entity.game.rooms.async_common_arena_match_ctrl.aca_match_message import AsyncCommonArenaMessage
...
class AsyncCommonArenaMatch(object, ):
    MAX_SEAT = 1000
    STATE_IDLE = 0
    STATE_STARTED = 1
    ...
    def save(self, userId, gameId):
        pass

    def resume(self, userId, gameId):
        """
        match resume
        """
        pass
    ...
    def revive(self, userId, gameId):
        """
        match back
        only in state STATE_LOSE
        """
        pass

    def challenge(self, userId, gameId):
        """
        比赛继续
        """
        pass
